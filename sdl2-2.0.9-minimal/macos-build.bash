...
cmake -DCMAKE_BUILD_TYPE=Debug \
  ...
  -DPULSEAUDIO=OFF -DDUMMYAUDIO=OFF -DDISKAUDIO=OFF -DOSS=OFF -DALSA=OFF -DJACK=OFF -DESD=OFF \
    -DARTS=OFF -DNAS=OFF -DSNDIO=OFF -DFUSIONSOUND=OFF -DLIBSAMPLERATE=OFF \
  -DVIDEO_COCOA=ON -DVIDEO_X11=OFF -DVIDEO_DUMMY=OFF -DVIDEO_WAYLAND_QT_TOUCH=OFF -DVIDEO_MIR=OFF \
  -DVIDEO_OPENGL=ON -DVIDEO_OPENGLES=OFF -DVIDEO_VULKAN=OFF -DVIDEO_DIRECTFB=OFF \
    -DVIDEO_VIVANTE=OFF -DVIDEO_KMSDRM=OFF \
  -DPTHREADS=OFF -DRPATH=OFF -DINPUT_TSLIB=OFF  -DSDL_DLOPEN=OFF \
