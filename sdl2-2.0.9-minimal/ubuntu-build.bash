...
cmake -DCMAKE_BUILD_TYPE=Debug \
  ...
  -DPULSEAUDIO=ON -DDUMMY_AUDIO=OFF -DDISK_AUDIO=OFF D-DOSS=OFF -DALSA=OFF -DJACK=OFF -DESD=OFF -DARTS=OFF -DNAS=OFF -DSNDIO=OFF -DFUSIONSOUND=OFF -DLIBSAMPLERATE=OFF \
  -DVIDEO_X11=ON -DVIDEO_DUMMY=OFF -DVIDEO_WAYLAND_QT_TOUCH=OFF -DVIDEO_MIR=OFF \
  -DVIDEO_OPENGL=ON -DVIDEO_OPENGLES=OFF -DVIDEO_VULKAN=OFF -DVIDEO_DIRECTFB=OFF -DVIDEO_VIVANTE=OFF -DVIDEO_KMSDRM=OFF \
  -DPTHREADS=ON -DRPATH=OFF -DINPUT_TSLIB=OFF \
